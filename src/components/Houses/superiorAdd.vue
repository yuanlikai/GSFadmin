...
<script type="text/ecmascript-6">
  export default {
    ...
    methods: {
        ...
        this.$refs[name].validate((valid) => {
          if (valid) {
            ...
            if (v.$route.query.hou_id || v.$route.query.deve) {
              v.Axios.post('/index.php/admin/hou/add', v.Qs.stringify({
      ...
      deveDetail() {
        let v = this;
        v.Axios.post('/index.php/admin/hou/xiang', v.Qs.stringify({
